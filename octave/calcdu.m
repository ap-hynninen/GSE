function U=calcdu(nx,ny,nz,Ex,Ey,Ez,ix,iy,iz)
    U = 0;
    for i=1:length(ix)
        x = ix(i);
        y = iy(i);
        ...
        %dEx_nn = Ex_p1-Ex_nn;
        %dEx_p1 = Ex_p2-Ex_p1;
        dEx_m1 = 5/6*(Ex_nn-Ex_m1) + 1/12*(Ex_p1-Ex_nn) + 1/12*(Ex_m1-Ex_m2);
        dEx_nn = 5/6*(Ex_p1-Ex_nn) + 1/12*(Ex_p2-Ex_p1) + 1/12*(Ex_nn-Ex_m1);
        dEx_p1 = 5/6*(Ex_p2-Ex_p1) + 1/12*(Ex_p3-Ex_p2) + 1/12*(Ex_p1-Ex_nn);
        ...
        %dEy_nn = Ey_p1-Ey_nn;
        %dEy_p1 = Ey_p2-Ey_p1;
        dEy_m1 = 5/6*(Ey_nn-Ey_m1) + 1/12*(Ey_p1-Ey_nn) + 1/12*(Ey_m1-Ey_m2);
        dEy_nn = 5/6*(Ey_p1-Ey_nn) + 1/12*(Ey_p2-Ey_p1) + 1/12*(Ey_nn-Ey_m1);
        dEy_p1 = 5/6*(Ey_p2-Ey_p1) + 1/12*(Ey_p3-Ey_p2) + 1/12*(Ey_p1-Ey_nn);
        ...
        %dEz_nn = Ez_p1-Ez_nn;
        %dEz_p1 = Ez_p2-Ez_p1;
        dEz_m1 = 5/6*(Ez_nn-Ez_m1) + 1/12*(Ez_p1-Ez_nn) + 1/12*(Ez_m1-Ez_m2);
        dEz_nn = 5/6*(Ez_p1-Ez_nn) + 1/12*(Ez_p2-Ez_p1) + 1/12*(Ez_nn-Ez_m1);
        dEz_p1 = 5/6*(Ez_p2-Ez_p1) + 1/12*(Ez_p3-Ez_p2) + 1/12*(Ez_p1-Ez_nn);
